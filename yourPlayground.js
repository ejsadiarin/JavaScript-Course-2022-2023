 ...
 *
 * @method split() - seperates words, letters, etc. given an argument (returns new array)
...
// get the data of a hero (simple consume API in JavaScript)
const accessToken = "127759136856495";
